...
This project now includes a simple HTML page for viewing and adding users.

- Visit `/` in the browser to see the users list and add-user form.
- The page displays all `User` records in a table.
- The form submits to `/create/` and adds a new user to the database.
